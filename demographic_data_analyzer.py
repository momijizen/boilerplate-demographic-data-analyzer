...
def calculate_demographic_data(print_data=True):
    ...
    list_hec =  round(df.loc[df['salary'] == '>50K','native-country'].value_counts() 
                / df['native-country'].value_counts() * 100 ,1)
    highest_earning_country = list_hec.idxmax()
    highest_earning_country_percentage = list_hec.max()
